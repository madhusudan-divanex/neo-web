                            ...
                            <div className="header-user dropdown tp-right-admin-details d-flex align-items-center">
                                ...
                                >
                                    ...
                                    <div className="profile-info me-1">
                                        <h4 className="profile-name">Sunil K.</h4>
                                        <p className="profile-id">Patient</p>
                                    </div>
                                    <FontAwesomeIcon
                                ...
                                >
                                    <div className="profile-card-box">
                                        <div className="profile-top-section">
                                            <img src="/call-pic.jpg" alt="Profile" className="profile-image" />
                                            <div className="profile-info">
                                                <h4 className="profile-name">Sunil Kumar Sharma</h4>
                                                <p className="profile-id">Patient</p>
                                            </div>
                                        </div>
...
export default DoctorHeaderSecond