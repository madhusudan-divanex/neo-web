...
import { faArrowLeft, faCalendar, faLocationDot, faMessage, faPhone, } from "@fortawesome/free-solid-svg-icons"

function LabTestDetailsCancel() {
  return (
   <>
...
export default LabTestDetailsCancel