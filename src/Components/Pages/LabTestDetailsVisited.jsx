...
import { faArrowLeft, faCalendar, faCircleXmark, faLocationDot, faMessage, faPhone, } from "@fortawesome/free-solid-svg-icons"

function LabTestDetailsVisited() {
  return (
    <>
                                    ...
                                    <div className="row">
                                            ...
                                            <div className="my-appointment-info-card ">
                                                <div className="my-appointment-tp-bx">
                                                    ...
                                                    <div className="appoint-right-title-bx">
                                                        <span className="nw-result-bx visited-bx">Visited</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-12 mb-3">
                                            <div className="lab-report-tp-bx">
                                                ...
                                                <div className="appointment-listing-bx py-5 text-center">
...
export default LabTestDetailsVisited